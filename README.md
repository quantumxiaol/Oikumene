...
- 校准战争和占领频率，避免少数 seed 完全无战争或占领长期没有结局。
- 把附庸、叛乱和撤军结果写回外交关系，让旧宗主、附庸和原主人之间形成长期记忆。
- 增强边境稳定观测：对比占领前后 contested tiles、control strength 和 polity stability 的变化。

...
class MapRenderer {
  public:
    void Draw(const World& world, const std::vector<TradeAgreement>& trades, const CameraController& camera,
              MapLayer layer, const std::optional<std::pair<int, int>>& hover_tile, const Selection& selection) const;
